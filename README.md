...
- `force_refresh` *(tùy chọn)*: Nếu bằng `true`, hệ thống sẽ phớt lờ Cache trong DB và ép trình duyệt cào lại data mới nhất từ nguồn web. Mặc định `false` (sẽ dùng Cache nếu chưa hết hạn).
